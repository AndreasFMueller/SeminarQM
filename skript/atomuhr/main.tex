...
erl"autert werden.
\index{Atomuhr!Rubidium}

\section{Quantenmechnanische Betrachtung}
\rhead{Quantenmechanische Betrachtung}
...
Rubidium hat einen Hyperfeinstrucktur"ubergang von $\nu =
...
\index{LPRO-101}%
\index{Frequenznormal}%
\index{Rubidium-Frequenznormal}%
...
\begin{figure}
  ...
  \subfigure[ohne \SI{6.8}{\giga\hertz} Anregung]{
    \input{atomuhr/uebergaengeOhne.tex}}\\
  \subfigure[mit \SI{6.8}{\giga\hertz} Anregung]{
    \input{atomuhr/uebergaengeMit.tex}}
