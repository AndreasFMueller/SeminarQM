...
%                           shorten >=0.1cm,
  ...
  \draw[trans, orange!90!black] (6.5cm,0.4cm) -- (6.5cm,0cm);
  ...
  \draw[photon, blue!70!black, -, decoration={post length=0}]
    (1.55, 2cm) --++ (5.45cm,0);
  \draw[photon, blue!70!black, decoration={amplitude=0.3mm}]
    (7cm, 2cm) --++ (1.5cm,0);
  %   hf
  \draw[photonHFG, orange!90!black] (9.5cm, 0.2cm)
     --++ (-1.7cm,0) node[midway,yshift=3.2mm]{\SI{6.8}{\giga\hertz}};
\end{tikzpicture}