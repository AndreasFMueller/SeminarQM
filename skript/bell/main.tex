...
Dazu wird eine verborgene, \emph{lokale} Variablen eingef\"uhrt, welche das
...
Wir betrachten das Paper von Bell indem wir erneut das Gedankenexperiment nach
Abbildung~\ref{fig:bell:EPR_Messaufbau} betrachten.
...
Der Spin eines Teilchens in einer beliebigen Richtung $\vec{a}$ wird durch die
