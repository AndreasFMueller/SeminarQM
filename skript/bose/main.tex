...
\begin{equation*}
= \textcolor{red} {(1+e^{- \beta \epsilon_1 }+e^{- \beta \epsilon_2 \cdot 2  }+e^{- \beta \epsilon_3 \cdot 3  }+...)} \cdot \textcolor{blue} {(1+e^{- \beta \epsilon_1 }+e^{- \beta \epsilon_1 \cdot 2  }+e^{- \beta \epsilon_1 \cdot 3  }+...)} \cdot ...
\end{equation*}
