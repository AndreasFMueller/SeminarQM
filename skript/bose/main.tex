...
=  \sum_{i = 0}^{N}  \textcolor{red}{ e^{- \beta \epsilon_i n_i }} \textcolor{blue} {e^{- \beta \epsilon_1 n_1 }} e^{- \beta \epsilon_2 n_2 } ... 
\end{equation}
...
Die Summe stellt die geometrische Reihe dar, dadurch kann die ganze Summe durch einen simplen Bruch ersetzt werden.
...
\begin{figure}
    \centering
    \includegraphics[width = 0.6\textwidth]{./bose/gauss1.png}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.6\textwidth]{./bose/gauss2.png}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.6\textwidth]{./bose/gauss3.png}
...
Also wird eine Abk"uhlung dazu f"uhren, dass sich alle Teilchen in einen Zustand bewegen.
