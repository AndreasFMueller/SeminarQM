...
also ist die negative L"osung ohnehin nicht n"otig.
...
F"ur Drehimpulszust"ande eines Atomes sind also nur ganzzahlige 
Werte m"oglich.
Die m"oglichen Werte sind in den Abbildungen~\ref{skript:drehimpulsrange}
und \ref{skript:drehimpulsspektrum} dargestellt.

Der Spin (Kapitel~\ref{chapter:spin}) hat die gleichen Eigenschaften
wie der Drehimpuls, aber mindestens f"ur einzelne Teilchen
wie Elektronen oder Protonen ist $l=\frac12$ und $m=\pm\frac12$.
