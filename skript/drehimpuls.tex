...
\biggr).
\end{align*}
Der Drehimpulsbetrag setzt sich einerseits aus $L_+L_-+L_-L_+$ und
andererseits aus $L_3^2$ zusammen. Wir berechnen den ersten Teil:
\begin{align*}
L_+L_-+L_-L_+
&=
\hbar^2
...
x_3\frac{\partial}{\partial x_1}
+
ix_3\frac{\partial}{\partial x_2}
-
(x_1+ix_2)\frac{\partial}{\partial x_3}
\biggr)
\biggl(
-
x_3\frac{\partial}{\partial x_1}
...
\\
&=
-\hbar^2x_3^2\frac{\partial^2}{\partial x_1^2}
-\hbar^2x_3^2\frac{\partial^2}{\partial x_2^2}
-\hbar^2(x_1^2+x_2^2)\frac{\partial^2}{\partial x_3^3}
+\dots
\end{align*}

\subsection{Kugelkoordinaten}
Die Schr"odingergleichung des Wasserstoffatoms wurde in Kugelkoordinaten 
gel"ost, weil diese der Kuglsymmetrie des Problems besser gerecht werden.
Um den Einfluss des Drehimpulses auf die Energie zu verstehen, m"ussen wir
auch die Drehimpulsoperatoren in diesen Koordinaten ausdr"ucken. 
...
r\cos\vartheta
\end{align*}
Wir brauchen aber auch Formeln, die uns erlauben, Ableitungen nach
kartesischen Koordinaten durch Ableitungen nach $r$, $\vartheta$ und
$\varphi$ zu ersetzen.
Dazu verwenden wir nat"urlich die Kettenregel, dazu brauchen wir die
Ableitungen der kartesischen Koordinaten nach Kugelkoordinaten.
...
\end{align*}
Die Ableitungn von $r$ wurden bereits bereichnet, und k"onnen hier
eingesetzt werden:
\begin{align*}
\frac{\partial\vartheta}{\partial z}
&=
...
Wir verwenden die Formeln f"ur die kartesischen Ableitungsoperatoren
in Kugelkoordinaten jetzt, um die Drehimpulsoperatoren auszudr"ucken.
