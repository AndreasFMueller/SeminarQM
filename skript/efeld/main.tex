...
Diese Funktion dr\"uckt mit dem Parameter $U$ das eingeschaltete elektrische Feld \"uber dem Potentialkasten
...
Mit $\gamma$ kann man die Wellenfunktion normieren.
Das ist n"otig wenn die St"orung Energie hinzuf"ugt
und so die Wahrscheinlichkeitsverteilung nicht mehr stimmt ($P \ne 1$).
...
Bei Symmetrien ist wichtig ob die Exponenten unsere Funktionen
...
\begin{figure}
 ...
 \caption{$\psi$ ungest\"ort in blau und $\psi$ gest\"ort in rot, zur besseren Anschauung jeweils um $10^5$ versetzt}
 \label{abb:efeld_psi_gestoert}
\end{figure}

% FIXME Beschreibung zum 100-sten
Durch die St\"orung wird das Elektron tendentiel nach rechts verschoben.

\begin{figure}
 \centering
 \includegraphics[width=12cm,clip=true,trim=2cm 7cm 1cm 8cm]{efeld/Psi_100_gestoert.pdf}
 \caption{100-stes Energieniveau von $\psi$ ungest\"ort in blau und $\psi$ gest\"ort in rot.}
 \label{abb:efeld_psi_gestoert}
\end{figure}
...
\begin{figure}
 ...
 \caption{$E$ gest\"ort, horizontale Achse ist $\varepsilon$, vertikale Achse ist die gesamte Energie des Systems}
