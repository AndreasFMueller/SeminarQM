...
\begin{center}
	...
	\begin{tabular}{lp{9cm}}
		\verb|vektor = n : m| & ein Vektor wird mit Werten von $n$ bis $m$ erzeugt \\
		\verb|vektor = n : delta : m| & ein Vektor mit Werten von $n$ bis $m$ erzeugt, welche voneinander den Abstand $delta$ haben \\
		\verb|vector(:)| & alle Werte aus einem Vektor werden ausgelesen \\
		\verb|matrix * matrix| & entspricht einem Matrixprodukt \\
		\verb|vector .* vector| & multipliziere die Elemente der Vektoren \\
		\verb|dot(vectorA, vectorB)| & bildet das Skalarprodukt zweier Vektoren
	\end{tabular}
\end{center}
