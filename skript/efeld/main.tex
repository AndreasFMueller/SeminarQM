...
Im Kapitel \ref{skript:stoerungsloesung1ordnung} Schr"odingergleichung wird beschrieben wie man das machen kann.
...
\]
dass die Energie immer am steigen ist.

Da wir keine Entartung haben folgende Gleichungen:
\begin{equation}
\begin{aligned}
E_k^{(1)} &=
