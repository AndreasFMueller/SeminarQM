...
\[
  k-l \equiv 1 \mod 2
\]
und daraus folgt die Bedingung
\begin{equation}
  ...
  k-l \equiv 1 \mod 2
\end{equation}
welche den Rechenaufwand halbiert.
...
ersten bis $n$-ten ausser dem f\"unften und den geraden auf.
\begin{equation}
...
for l = 1 : n
  if l ~= k           # Vergleich l ungleich k % FIXME l-k = 1 mod 2
