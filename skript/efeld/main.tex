...
\begin{aligned}
  \varepsilon H_1(x) &= \varepsilon a e_{-} x +b  \\
                     &= \varepsilon \frac{ U }{2 l} e_{-} x + 0  \Longrightarrow \\
         \varepsilon &= \frac{ U }{2 l} e_{-}; \, a = 1
\end{aligned}
\end{equation}
...
Die einzelnen Grafiken zeigen sehr anschaulich wie die Differenz zwischen dem ungest\"orten und dem gest\"orten $\psi$
...
% FIXME Beschreibung zum 100-sten korrekt?
Betrachten wir nun das 100-ste etwas genauer.
In der Abbildung \ref{abb:efeld_psi_100_gestoert} sehen wir wie die St\"orung die Frequenz der Wellenfunktion ver\"andert wird.
Die gelben Balken geben an, wie stark die Periodendauer zwischen zwei Nulldurchg"angen von der ungest"orten Funktion abweicht.
Wir k"onnen darin gut die Form der St"orung $H_1$ wiedererkennen.
Die Kr"ummung in der Kurve kommt davon dass wir in der Mitte eine Erh"ohung der Amplitude haben.
Diese entsteht durch die Stauchung der Wellenfunktion und verursacht das wir mehr Energie bei gleicher Periodendauer haben.
