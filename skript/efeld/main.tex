...
Auf der Abbildung \ref{abb:efeld_psi_gestoert} werden die Unterschiede zwischen ungest\"orten $\psi$ (schwarz) \&
dem gest\"orten $\psi$ (rot) gezeigt.
In der horizontalen Richtung sind die jeweiligen N"aherungen aufgef\"uhrt. Die Werte der Kurven pendeln um Null \& 
wurden nur der Lesbarkeit halber getrennt.
