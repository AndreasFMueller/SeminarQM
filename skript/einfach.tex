...
nicht unterscheidbar sind. Man kann dann sagne, dass sich die
...
die sowohl stetige ode diskrete Zustandsvariablen sein k"onnen.
...
werden. Wir schreiben daher eine Zustand als ein Vektor
\[
...
Die Quantenmechaink ist also eine Mechanik von Zust"anden: sie beschreibt,
...
es einen Analysator gibt, man nennt solche Gr"ossen Observable.
...
\]
dar. Das Symbol ist so zu lesen: wenn der Analysator auf ein Teilchen
im Zustand $a_i$ trifft, dann gibt er ein solches Teilchen weiter.
...
Messsymbolen rechnen wie f"ur Matrizen "ublich rechnen kann.
...
was alleine mit rellen Werten f"ur die Transformationsfunktion nicht
...
\end{equation}
Wir nennen dies die hermitesche Symmetrie der Transformationsfunktion.
...
Zahlen
$\langle a_j|A|a_i\rangle$, sie heissen die Matrixelemente von $A$.
...
sie heisst auch die adjungierte Matrix.
...
=
\sum_i\langle \psi|i\rangle\langle i|V|i\rangle\rangle i|\psi\rangle
=
