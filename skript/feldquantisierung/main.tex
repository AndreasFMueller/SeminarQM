...
Hier muss $n$ ein Integer sein, damit die absteigende Folge bei null stehen bleibt. Die absteigende Folge der Zustände ist:
...
Durch hinzufügen von Photonen mittels dem Aufsteige-Operator k"onnen nun Photonen hinzugef"ugt werden:
...
Der Hamilton-Opperator angewendet auf viele Photonen ergibt nun als Eigenwert die Summe der Energie der Photonen mit den Zuständen $(k_i,\alpha_i)$:
