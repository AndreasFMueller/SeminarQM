...
Die Absicht ist es den Zustand des Floating Gates zu erh"ohen.
Dies kann man erreichen, indem im Floating Gate eine gewisse Ladung
gespeichert wird.
Diese kann erh"oht werden, indem das Potential am Control Gate erh"oht wird.
Nun fliessen die Elektronen in Richtung Source.
...
Zust"ande gespeichert werden.
In einem Floating Gate Transistor kann man auch mehrere Bits speichern,
"ublicherweise werden 2 Bits gespeichert.
...
Wegem dem Tunneleffekt fliessen die Elektronen durch die Oxidschicht,
dadurch wird diese Oxidschicht, um das Floating Gate herum, immer ein
kleines bisschen besch"adigt.
Dies bewirkt, dass immer mehr der Ladung abfliessen kann.
...
Dieses Problem ist jedoch nicht so problematisch, da der Speicher mit
...
Am Anfang befindet sich im Potentialtopf eine Grundenergie $E_{0}$ das
Ziel ist es diese Energie auf ein h"oheres Energieniveau $E_{1}$ zu bringen.
...
Schlussendlich wird die Wahrscheinlichkeit eines Zustandes im
Potentialtopf errechnet.
Diese Wahrscheinlichkeit ist abh"angig von der Energie des Elektrons,
vom Abstand des Elektrons zum Potentialtopf und der Geschwindigkeit
...
Wenn man das auf das Modell des Wackelpudding "ubertr"agt, erkennt man,
...
Somit ergibt sich dann folgendes Diefferentialgleichungssystem:
\[
