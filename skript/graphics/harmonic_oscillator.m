...
#fprintf(fid, "endfor;\n")
fprintf(fid, "path r;\n")
fprintf(fid, "r := (-4 * unit,potential(-4));\n")
fprintf(fid, "for x = -4 step 0.1 until 4.01:\n")
fprintf(fid, "    r := r--(x * unit, potential(x));\n")
fprintf(fid, "endfor;\n")
fprintf(fid, "numeric s;\n")
fprintf(fid, "s := 0;\n")
fprintf(fid, "fill r--(4 * unit + s, potential(4))\n")
fprintf(fid, "        --(4 * unit + s, 0)--(-4 * unit - s, 0)\n")
fprintf(fid, "        --(-4 * unit - s, potential(-4))--cycle\n")
