...
\index{Vertauschungsrelationen!harmonischer Oszillator}%
...
\]
\index{Vertauschungsrelationen!Ort und Impuls}%
...
a^+=\frac1{\sqrt{2}}(Q-iP).
\]
\index{Auf- und Absteigeoperator!harmonischer Oszillator}%
...
\index{Vertauschungsrelationen!Auf- und Absteigeoperatoren}%
\begin{align*}
aa^+
&=
