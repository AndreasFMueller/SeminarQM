...
.
\end{align*}
Das Produkt zweier Matrizen der Form (\ref{su2form}) ist also wieder eine
...
$[\;\cdot\;,\;\cdot\;]$,
welche die Jacobi-Identit"at (\ref{jacobi}) erf"ullt, heisst eine
Lie-Algebra.
...
Aus Formel (\ref{detandtrace}) schliessen wir, dass die Spur
