...
\rhead{Anwendungen ausserhalb der Medizin}
...
der Tabelle~\ref{mri:bsp:tab:NMR_Kerne} l"asst sich feststellen,
...
\end{figure}
Die Verschiebung der Frequenz (Abweichung auf der $x$-Achse) ist
