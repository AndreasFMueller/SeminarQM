...
%	Wie sich in Kapitel \ref{sec:quant} zeigen wird, ist der exakte Winkel für die weiteren Berechnungen nicht entscheidend.
...
%verschiedene Magnetfeldstärken, bis 0.5 Tesla Permanentmagnete
%
%\section{Grundlagen}
%
%\subsection{Magnetismus}
...
%	\caption{Präzession \cite{praezession}}
%	\label{fig:spin}
%\end{figure}
%
%\subsubsection{Larmor-Präzession}
%
%
%
