...
=0.
\label{kontinuitaetsgleichung1d}
\end{equation}
Die Gr"osse $j(x)=\varrho(x)v(x)$ beschreibt den Materialstrom.
Die Gleichung (\ref{kontinuitaetsgleichung1d}) heisst die
...
Kontinuit"atsgleichung
\[
\frac{\partial\varrho(x,t)}=\frac{\partial j(x,t)}{\partial x}
+\varphi(x,t)\varrho(x,t).
\]
