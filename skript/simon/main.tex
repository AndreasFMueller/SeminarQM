...
\begin{figure}
 ...
 \begin{tikzpicture}[ele/.style={fill=black,circle,minimum width=1pt,inner sep=1pt},every fit/.style={ellipse,draw,inner sep=-2pt}]
  ...
  \node[ele,,label=right:$D$] (b1) at (4,4) {};
  \node[ele,,label=right:$B$] (b2) at (4,3) {};
  \node[ele,,label=right:$C$] (b3) at (4,2) {};
  \node[ele,,label=right:$A$] (b4) at (4,1) {};
...
Werten von $x$ mit der gleichen Wahrscheinlichkeit auftreten. Sinnhaft
gesprochen heisst das, dass auf einmal alle möglichen Werte auf dem ersten
