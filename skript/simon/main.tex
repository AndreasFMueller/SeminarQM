...
unterschieden lässt, um welchen Wert es sich handelt. Denn falls $x$ gemessen
wird ist nicht klar, dass diser nicht $x \oplus s$ ist. Es hilft auch nicht
$s$ zu finden.

Um bei der Messung den Wert nicht zu bekommen wird ein Trick verwendet. Dafür
...
% TODO: Grafik für linear und beispiel zeigen
