...
\begin{figure}
 ...
 \begin{tikzpicture}[ele/.style={fill=black,circle,minimum width=1pt,inner sep=1pt},every fit/.style={ellipse,draw,inner sep=-2pt}]
  ...
  \node[ele,label=left:$000$] (a1) at (0,8) {};
  \node[ele,label=left:$001$] (a2) at (0,7) {};
  \node[ele,label=left:$010$] (a3) at (0,6) {};
  \node[ele,label=left:$011$] (a4) at (0,5) {};
  \node[ele,label=left:$100$] (a5) at (0,4) {};
  \node[ele,label=left:$101$] (a6) at (0,3) {};
  \node[ele,label=left:$110$] (a7) at (0,2) {};
  \node[ele,label=left:$111$] (a8) at (0,1) {};

  \node[ele,,label=right:$000$] (b1) at (4,8) {};
  \node[ele,,label=right:$001$] (b2) at (4,7) {};
  \node[ele,,label=right:$010$] (b3) at (4,6) {};
  \node[ele,,label=right:$011$] (b4) at (4,5) {};
  \node[ele,,label=right:$100$] (b5) at (4,4) {};
  \node[ele,,label=right:$101$] (b6) at (4,3) {};
  \node[ele,,label=right:$110$] (b7) at (4,2) {};
...
\begin{figure}
 ...
 \begin{tikzpicture}[ele/.style={fill=black,circle,minimum width=1pt,inner sep=1pt},every fit/.style={ellipse,draw,inner sep=-2pt}]
  \node [] {$x$};
  \node [xshift=4.0cm] {$f(x)$};
  \node[ele,label=left:$000$] (aa1) at (0,8) {};
  \node[ele,label=left:$001$] (aa2) at (0,7) {};
  \node[ele,label=left:$010$] (aa3) at (0,6) {};
  \node[ele,label=left:$011$] (aa4) at (0,5) {};
  \node[ele,label=left:$100$] (aa5) at (0,4) {};
  \node[ele,label=left:$101$] (aa6) at (0,3) {};
  \node[ele,label=left:$110$] (aa7) at (0,2) {};
  \node[ele,label=left:$111$] (aa8) at (0,1) {};

  \node[ele,,label=right:$000$] (bb1) at (4,8) {};
  \node[ele,,label=right:$001$] (bb2) at (4,7) {};
  \node[ele,,label=right:$010$] (bb3) at (4,6) {};
  \node[ele,,label=right:$011$] (bb4) at (4,5) {};

  \node[draw,fit= (aa1) (aa2) (aa3) (aa4) (aa5) (aa6) (aa7) (aa8),minimum width=2cm] {} ;
  \node[draw,fit= (bb1) (bb2) (bb3) (bb4), minimum width=2cm] {} ;
