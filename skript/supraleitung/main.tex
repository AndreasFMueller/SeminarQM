...
Wechselwirkungs-Reihenfolge enth"alt, also dem Term der in Abbildung \ref{supraleitung:FeynmanDiagram1} rechts zu sehen ist.
...
\end{gather}
Zu beachten ist, dass die Energie $\hbar \omega_q$ relativ klein gegen"uber der Fermienergie $E_F$ ist. Denn Phononen k"onnen als Gitterschwingungen vergleichsweise
nur kleine Energien transportieren.
In erster N"aherung entspricht die maximale Phononenfrequenz $\omega_q$ der \index{Debye-Frequenz} Debye-Frequenz $\omega_D$ und der damit verbundenen
Energie $\hbar \omega_D$.

\subsubsection{Optimaler Gesamtimpuls von $k_1$ und $k_2$}
\rhead{Optimaler Gesamtimpuls von k1 und k2}
