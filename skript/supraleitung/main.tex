...
Die Coulomb-Wechselwirkung zwischen Elektronen und Gitter hat jedoch keinen Einfluss auf die
Elektron-Elektron Wechselwirkung.
...
%Versuch Simon Bilder anzuordnen
%TODO noch anpassen, Anfangskommentar und Schlusskommentar entfernen
\begin{figure}
\centering
  \begin{tabular}{l l}
  \centering
    ...
    \\
  \end{tabular}
  \caption{Gitter Elektron sowas!
  \label{supraleitung:Gitter}}
\end{figure}
% end Versuch

Diese Wechselwirkung zwischen den Elektronen nur grafisch zu betrachten reicht nicht um eine Aussage
"uber Anziehung oder Abstossung zu machen.
...
Dabei sind die Valenzelektronen nicht an die einzelnen Atome gebunden sondern k"onnen sich,
...
Die Wellenfunktion des Elektronenpaares wird durch die Anwendung zweier Erzeugnisoperatoren
auf den Grundzustand $|G\rangle$ der gef"ullten Fermikugel aufgebaut, indem wir "uber
alle m"oglichen $k_1$ und $k_2$ $(|k_i| \ge k_f)$ und "uber die Elektronenspins summieren.
...
(\ref{supraleitung:WellenfktAllg}) unter der Nebenbedingung $K=k_1+k_2=const$ aus.
...
a) beliebiges K gew"ahlt 			%K gr"osser 0, kleiner Ef+hwq, mit Fl"achenmarkierung

\includegraphics[width=0.6\textwidth]{supraleitung/Graphics/kGraphic06g.pdf} 

b) K zu gross grw"ahlt							%K zu gross

\includegraphics[width=0.6\textwidth]{supraleitung/Graphics/kGraphic09g.pdf} 

c) Maximale Anzahl M"oglichkeiten um $k_1$, $k_2$ zu w"ahlen mit K = 0 	%K gleich 0, mit Fl"achenmarkierung

\caption{
Visualisierung des Gesamtimpulses im $k$-Raum
%a) K beliebig,
%b) K zu gross,
...
dass die Elektronenspin antiparallel sind.
...
$antiparallel$ sind, ergibt sich die vereinfachte Wellenfunktion
